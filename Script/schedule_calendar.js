const months2 = [
  ...
  function getCurrentDate(element, asString) {
    if (element) {
        if (asString) {
            return element.textContent = weekdays[dateSc.getDay()] + ', ' + dateSc.getDate() + " de " + months2[dateSc.getMonth()] + " de " + dateSc.getFullYear();
        }
  ...
  function changeHeader(dateHeader) {
    ...
    const textMonth = document.createTextNode(months2[dateHeader.getMonth()].substring(0, 3) + " " + dateHeader.getFullYear());
  ...
  document.onload = generateCalendar(dateSc);
